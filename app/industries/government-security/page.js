      ...
      <main>
        ...
        <section className="container mx-auto py-8 px-4">
          ...
          <AnimatedSection className="text-lg font-figtree mb-4 max-w-3xl mx-auto">
            <p>
              Agencies face limited verification, no real-time optimization, and weak offline attribution for OOH buys.
              Buyers want programmatic workflows and receipts that reconcile to billing.
            </p>
          </AnimatedSection>
        </section>
        <section className="container mx-auto py-8 px-4">
          ...
          <AnimatedSection className="text-lg font-figtree mb-4 max-w-3xl mx-auto">
            <p>
              Boldstreet OOH exposes inventory as programmatic impressions, uses LOOK and RAVEN signals for audience
              validation, and records verified impressions on blockchain for reconciled billing. DCO and RTB increase
              yield and campaign effectiveness.
            </p>
          </AnimatedSection>
        </section>
        <section className="container mx-auto py-8 px-4">
        ...
        <section className="container mx-auto py-8 px-4">
          ...
          <AnimatedSection className="text-lg font-figtree mb-4 max-w-3xl mx-auto">
            <p>
              GDPR-style anonymization, creative safety checks, and opt-out signage for venues ensure ethical and compliant
              operations.
            </p>
          </AnimatedSection>
        </section>
        <section className="container mx-auto py-8 px-4 text-center">
          ...
          <AnimatedSection className="text-lg font-figtree mb-4 max-w-3xl mx-auto">
            <p>
              Schedule a demo to explore how Boldstreet OOH can transform your next campaign with programmatic precision
